...
esferas = [
    Esfera(1.0, 0.0, 0.0, 0.0, 0.7, 0.0, 0.7, 0.07, (245, 230, 100)),    # vy aumentado a 0.7
    Esfera(0.0, 1.1, 0.0, -0.7, 0.0, 0.0, 0.3, 0.03, (245, 150, 30)),   # vx aumentado a -0.7
    Esfera(-1.0, 0.0, 0.0, 0.0, -0.5, 0.0, 0.5, 0.05, (100, 230, 245)),  # vy aumentado a -0.5
    Esfera(0.0, -1.5, 0.0, 0.5, 0.0, 0.0, 0.6, 0.06, (30, 150, 245)),    # vx aumentado a 0.5
    Esfera(1.3, 0.0, 0.0, 0.0, 0.3, 0.0, 0.4, 0.04, (30, 245, 150)),     # vy aumentado a 0.3
    Esfera(0.3, 1.4, 0.0, -0.3, 0.0, 0.0, 0.8, 0.08, (150, 245, 30)),    # vx aumentado a -0.3
    Esfera(-1.5, 0.0, 0.0, 0.0, -0.2, 0.0, 0.3, 0.03, (245, 30, 150))    # vy aumentado a -0.2
]
