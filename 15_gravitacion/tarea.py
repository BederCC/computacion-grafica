...
camera_angle = -pi/4  # Ajustar el ángulo para vista isométrica
camera_height = 2.5
...
esferas = [
    Esfera(1.0, 0.0, 0.0, 0.0, 0.7, 0.1, 0.7, 0.1, (245, 230, 100)),   # Planeta 1 (más grande)
    Esfera(0.0, 1.1, 0.0, -0.7, 0.0, 0.1, 0.3, 0.05, (245, 150, 30)),  # Planeta 2
    Esfera(-1.0, 0.0, 0.0, 0.0, -0.5, 0.1, 0.5, 0.07, (100, 230, 245)),# Planeta 3
    Esfera(0.0, -1.5, 0.0, 0.5, 0.0, 0.1, 0.6, 0.08, (30, 150, 245)),  # Planeta 4
    Esfera(1.3, 0.0, 0.0, 0.0, 0.3, 0.1, 0.4, 0.06, (30, 245, 150)),   # Planeta 5
    Esfera(0.3, 1.4, 0.0, -0.3, 0.0, 0.1, 0.8, 0.09, (150, 245, 30)),  # Planeta 6
    Esfera(-1.5, 0.0, 0.0, 0.0, -0.2, 0.1, 0.3, 0.05, (245, 30, 150))  # Planeta 7
]
...
def reshape(w, h):
    ...
    glLoadIdentity()
    gluPerspective(10.0, float(w)/float(h), 1.0, 1000.0)
...
def update_camera():
    global camera_angle, camera_height, camera_distance
    gluLookAt(camera_distance*cos(camera_angle), camera_height, camera_distance*sin(camera_angle), 
...
def main():
    ...
    glutCreateWindow(b"Gravitacion Universal Mejorada")
